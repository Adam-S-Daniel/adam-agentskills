...
#
# Usage:
#   bash plugins/adam-coding-local/skills/sync-skills/setup.sh
#
...
# ── Register the global pre-push hook for adam-agentskills ────────────────
...
# ── Register for adam-agentskills-private if it exists ────────────────────
...
PRIVATE_REPOS+=(
  "$HOME/repos/adam-agentskills-private"
  "${USERPROFILE:-}/repos/adam-agentskills-private"
)
