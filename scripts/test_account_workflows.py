...
class TestRecordAccountUpload:
    ...
    def test_it_cannot_open_a_pull_request(self):
        ...
        overrides adam-agentskills to require it), and GitHub raises no workflow
    ...
    def test_it_pins_no_issue_or_pull_request_number(self):
        ...
        in an adam-agentskills summary reads, and links, as an adam-agentskills issue.
        """
        text = self._summary()
...
class TestTheAuditStepAnnouncesEveryDegradedVerdict:
    ...
    def test_the_case_block_names_every_status_the_module_knows(self):
        ...
        skills-evals moves a string no test here can see - adam-agentskills' CI has
    ...
    _NAMES_DEFINED_ELSEWHERE = {
        "_include_in_zip":
            "plugins/adam-coding-local/skills/sync-skills/sync_skills.py",
    }
...
class TestSkillInputIsValidatedBeforeUse:
    ...
    @pytest.mark.parametrize("name", [
        "sync-skills", "bell-schedule", "pdf-ocr-audit",
